...
public class ExpenseTracker {
    ...
    public static void main(String[] args) {
        // Declare and initialize the timer within the main method
    ...
    private static void addExpense() {
        ...
        String description = scanner.nextLine(); // Read the actual description
        ...
        if (!dueDateStr.isEmpty()) {
            try {
                ...
                System.out.println("Invalid date format. Due date not set. Please use yyyy-MM-dd.");
            }
        }
    ...
    private static void visualizeExpenses() {
        ...
        for (Expense expense : expenses) {
            ...
            // Iterate over existing keys, ignoring case
            for (Object key : dataset.getKeys()) {
                if (key.toString().equalsIgnoreCase(category)) {
                    double currentAmount = (double) dataset.getValue((Comparable<?>) key);
                    dataset.setValue((Comparable<?>) key, currentAmount + expense.amount);
                    found = true;
                    break;
                }
            }

            // If the category is not found, add it to the dataset
            if (!found) {
                dataset.setValue((Comparable<?>) category, expense.amount);
            }
        }
    ...
    // Moved ReminderTask outside of the main method
